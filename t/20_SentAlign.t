...
system("sed 's/certainty=\"[-0-9]*\"//' $DATA/xml/de-en/1988.basic.sent.xml > gold.xml");
...
is( compare( "align.xml", "$DATA/xml/de-en/1988.basic.hun.xml" ),0, "hunalign (de-en)" );
...
is( compare( "align.xml", "$DATA/xml/de-en/1988.basic.gma.xml" ),0, "gma (de-en)" );
