...
public class ScaniaSwedishPOSContextGenerator implements ContextGenerator {
    ...
    public ScaniaSwedishPOSContextGenerator () {
	_manalyzer = null;
    }
    
    public ScaniaSwedishPOSContextGenerator (MorphAnalyzer ma) {
	_manalyzer = ma;
	...
	*/
    ...
    public static void main(String[] args) {
	  ...
	  ScaniaSwedishPOSContextGenerator gen = new ScaniaSwedishPOSContextGenerator();
