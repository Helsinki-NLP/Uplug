...
public class CatEventCollector implements EventCollector {

    private BufferedReader br;
    private ContextGenerator cg = new POSContextGenerator();
    
    public CatEventCollector(Reader data) {
	...
	EventCollector ec = new CatEventCollector(new StringReader(data));
