 ...
 * lexicon entry with the right POS, semantic, etc. tags.<p>
 *
...
public class EnglishCommonFixedLexicalMWE extends LexicalMWE {
    private static final String modelFile = "data/EnglishCommonFixedLexicalMWE.data";
