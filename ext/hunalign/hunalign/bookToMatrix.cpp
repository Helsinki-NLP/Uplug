...
double characterLength( const Phrase& words )
{
                 ...
                 const SentenceList& sentenceList )
{
  ...
  {
    double len = characterLength(sentenceList[i].words) ;
...
void setSentenceValues( const SentenceList& sentences, SentenceValues& lengths )
{
  ...
  {
    lengths.push_back( characterLength(sentences[i].words) );
  }
}
